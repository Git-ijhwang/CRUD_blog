...
import { withStyles, Typography, 
          IconButton, Paper, List, ListItem,
...
class PostsManager extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Typography variant="h4">Posts Manager Page</Typography>
        ...
        {this.state.posts.length > 0 ? (
          ...
          !this.state.loading &&  <Typography variant='subtitle'>No posts to display</Typography>
        )}
        <Fab
          color="secondary"
          aria-label="add"
